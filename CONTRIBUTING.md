...
Thank you for your interest in contributing to Noize! This project is currently under active development and we appreciate any feedback, bug reports, or suggestions. Please read the guidelines below before opening an issue or submitting a pull request.
...
5. **Open a pull request** targeting the `main` branch with a descriptive title and description.

---
## 📝 Reporting Issues

If you encounter a bug or crash, please open an issue with the following information:

- Environment (OS, Flutter/Dart version, device/emulator).
...
This project follows the [Contributor Covenant Code of Conduct](https://www.contributor-covenant.org/version/2/0/code_of_conduct/). By participating, you agree to respect the community and maintain a friendly, inclusive environment.

---
## 🙏 Thank You

Whether you're filing an issue, testing a nightly build, or eventually submitting code, your interest helps make Noize better. We appreciate your time and support!
