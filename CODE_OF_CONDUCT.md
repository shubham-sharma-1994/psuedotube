...
When an incident does occur, it is important to report it promptly. To report a possible violation, please open a [GitHub Issue](https://github.com/anandssm/noize/issues) or contact the maintainer directly via the contact details listed in [SECURITY.md](SECURITY.md).
